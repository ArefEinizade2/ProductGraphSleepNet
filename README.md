...
## Generate the results on the public Montreal Archive of Sleep Studies (MASS)-SS3 database:
...
Step 3: Run `MASS_SS3_Train_Test.py` to generate the classification results and generate the learned temporal (i.e., "MASS_SS3_LearnedGraphsTempral.npy") and spatial (i.e., "MASS_SS3_LearnedGraphsSpatial.npy") graphs.

## Generate the results on the public SleepEDF database:
...
Step 3: Run `SleepEDF20_Train_Test.py` to generate the classification results.
...
- `MASS_SS3_Train_Test.py` and `SleepEDF20_Train_Test.py`: generate the results and generate the learned spatial and temporal graphs.
