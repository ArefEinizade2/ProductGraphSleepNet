...
val_list = [9, 8, 4, 7, 11, 3, 2, 0, 1, 10, 13, 5, 14, 12, 6, 5]
...
class kFoldGenerator():
    ...
    def getFold(self, i):
        ...
        channel_set = set(np.arange(0, 27))
        channel_set = channel_set.difference({22}) #rempove the reference A2 channel
        ...
        val_idx = [val_list[i]]
        print('Validation fold: '+ str(val_list[i]+1))
